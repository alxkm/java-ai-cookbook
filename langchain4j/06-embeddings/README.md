...
- [`Embeddings.java`](src/main/java/com/example/cookbook/Embeddings.java) - `embedAll(segments)` for the corpus, `embed(text)` for the query,
  `CosineSimilarity.between(...)` for the ranking.
